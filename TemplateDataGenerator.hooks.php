...
class TemplateDataGeneratorHooks {
	...
	public static function initGeneratorInEditForm( $editPage, $output ) {
		...
		$editPage->editFormPageTop .= '<button id="btnTemplateDataGenerator">' . wfMessage( 'templatedatagenerator-editbutton' )->text() . '</button>';
		$editPage->editFormPageTop .= '<div id="dialog-form" style="display:none;" title="' . wfMessage( 'templatedatagenerator-modal-title' )->text() . '"> </div>';
